...
## Purpose
Supports thinking/reasoning configuration options for reasoning models (e.g. OpenAI o1/o3, Ollama DeepSeek-R1) and styles the live thinking stream output in the terminal.
